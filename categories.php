...
<head>
    ...
    <title>GESTION_STOCK-Categories</title>
</head>
<body style="margin-top:0px;">
    ...
    <div>
        <section style="width:90%;margin:auto;">
            <h1 style="color:#161161;text-align:center;">Categories des produits</h1>
            <div align="right" style="margin-right:120px;">
             <a href="ajout_categorie.php" style="text-decoration:none;text-align:right;color:black;padding:8px;border-radius:5px;background:white;border:1px solid #161161;">Nouvelle catégorie</a>
            </div>
            <table class="tab">
                ...
                <?php include("recup_categories.php"); ?>
